        ...
        <div className="h-dvh flex flex-col from-gray-900 to-gray-800 bg-gradient-to-br">
            <div className="flex-1 overflow-y-auto scrollbar-hide px-5 pb-[100px]">
                ...
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h1 className="text-2xl font-bold text-white">{t("daily_pronunciation_history_title")}</h1>
                </div>
                ...
                {historico.length === 0 && (
                    <p className="text-gray-400 text-center mt-10">{t("daily_pronunciation_history_empty")}</p>
                )}
