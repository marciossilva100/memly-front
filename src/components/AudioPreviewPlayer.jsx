...
export default function AudioPreviewPlayer({ src }) {
    ...
    return (
        <div className="w-full flex items-center gap-3 px-3 py-3 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-700">
            <button
                type="button"
                onClick={alternar}
                className="w-10 h-10 shrink-0 rounded-full bg-[#4cb8c4] hover:bg-[#3da5b0] flex items-center justify-center transition-colors"
            >
                {tocando
