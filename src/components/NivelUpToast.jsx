            ...
            <div className="bg-gray-800/95 backdrop-blur-sm border border-white/15 text-white text-sm px-4 py-3 rounded-xl shadow-lg">
                <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-xs mt-1">{t("level_up_suggestion_body")}</p>
                    </div>
                    <button type="button" onClick={recusar} className="text-gray-400 hover:text-white shrink-0">
                        <X className="w-4 h-4" />
                    </button>
                </div>
