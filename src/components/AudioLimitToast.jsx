            ...
            {estado !== "escondido" && (
                ...
                >
                    <button
                        ...
                        className="w-full flex items-start gap-2 bg-gray-800/95 backdrop-blur-sm border border-yellow-500/40 text-white text-sm font-medium px-4 py-3 rounded-xl shadow-lg text-left"
                    >
                        <Crown className="w-4 h-4 shrink-0 mt-0.5 text-yellow-400" />
