    ...
    return (
        <div className="px-5">
            ...
            {!loading && frases.map(item => (
                <div key={item.id} className="grid grid-cols-[1fr_1fr_auto] gap-4 items-center  py-3 border-b-2" >
            ...
            <div className="flex fixed bottom-0 left-0 w-full justify-center items-center py-4">
                <button className="
                    px-6
                    py-3
                    rounded-full
